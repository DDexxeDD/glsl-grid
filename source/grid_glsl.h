...
/*
    ...
    Overview:
        ...
        Shader program 'grid':
            ...
            Fragment shader: fs_grid
                Uniform block 'fs_grid_params':
                    C struct: fs_grid_params_t
                    Bind slot: SLOT_fs_grid_params = 0
    ...
    Bind slot and C-struct for uniform block 'fs_grid_params':

        fs_grid_params_t fs_grid_params = {
            .grid_height = ...;
        };
        sg_apply_uniforms(SG_SHADERSTAGE_[VS|FS], SLOT_fs_grid_params, &SG_RANGE(fs_grid_params));
...
#pragma pack(pop)
#define SLOT_fs_grid_params (0)
#pragma pack(push,1)
SOKOL_SHDC_ALIGN(16) typedef struct fs_grid_params_t {
    float grid_height;
    uint8_t _pad_4[12];
} fs_grid_params_t;
#pragma pack(pop)
...
/*
    ...
    {
        vec4 _87 = (frag_projection * frag_view) * vec4(position, 1.0);
        return 0.5 + (0.5 * (_87.z / _87.w));
    }
    
    float compute_linear_depth(vec3 position)
    {
        vec4 _111 = (frag_projection * frag_view) * vec4(position, 1.0);
        return 1.0 / (100.5 - ((((_111.z / _111.w) * 2.0) - 1.0) * 99.5));
    }
    
    vec4 grid(vec3 frag_position_3d, float scale)
    {
        vec2 _31 = frag_position_3d.xz * scale;
        vec2 _45 = abs(fract(_31 - vec2(0.5)) - vec2(0.5)) / fwidth(_31);
        return vec4(0.20000000298023223876953125, 0.20000000298023223876953125, 0.20000000298023223876953125, 1.0 - min(min(_45.x, _45.y), 1.0));
    }
    
    void main()
    {
        float _162 = (fs_grid_params[0].x - near_point.y) / (far_point.y - near_point.y);
        vec3 _170 = near_point + ((far_point - near_point) * _162);
        vec3 param = _170;
        ...
        vec3 param_4 = _170;
        float param_5 = 1.0;
        frag_color = (grid(param_2, param_3) + grid(param_4, param_5)) * float(_162 > 0.0);
        frag_color.w *= max(0.0, 0.5 - compute_linear_depth(param_1));
    }
    
*/
static const char fs_grid_source_glsl330[1328] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x33,0x30,0x0a,0x0a,0x75,0x6e,
    0x69,0x66,0x6f,0x72,0x6d,0x20,0x76,0x65,0x63,0x34,0x20,0x66,0x73,0x5f,0x67,0x72,
    0x69,0x64,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x5b,0x31,0x5d,0x3b,0x0a,0x69,0x6e,
    ...
    0x0a,0x20,0x20,0x20,0x20,0x76,0x65,0x63,0x34,0x20,0x5f,0x38,0x37,0x20,0x3d,0x20,
    0x28,0x66,0x72,0x61,0x67,0x5f,0x70,0x72,0x6f,0x6a,0x65,0x63,0x74,0x69,0x6f,0x6e,
    0x20,0x2a,0x20,0x66,0x72,0x61,0x67,0x5f,0x76,0x69,0x65,0x77,0x29,0x20,0x2a,0x20,
    ...
    ,
    ...
    ,
    ...
    ,
    ...
    ,
...
static inline const sg_shader_desc* grid_shader_desc(sg_backend backend) {
  if (backend == SG_BACKEND_GLCORE33) {
    ...
    if (!valid) {
      ...
      desc.fs.uniform_blocks[0].layout = SG_UNIFORMLAYOUT_STD140;
      desc.fs.uniform_blocks[0].uniforms[0].name = "fs_grid_params";
      desc.fs.uniform_blocks[0].uniforms[0].type = SG_UNIFORMTYPE_FLOAT4;
